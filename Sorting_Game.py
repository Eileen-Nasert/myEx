...
def your_house():
	...
	print "Number 1, 2, 3, 4 and 5, for when you didn't choose one of the answers I offerd you."
	
	number = raw_input("> ")
	if number == "1":
		print "Congratulations! 
		print name
		print "You are a Ravenclaw! The Grey Lady is so happy your\nare in her house!" 
	elif number == "2":
		print "Congratulations! You are a Hufflepuff! The Fat Friar is eager to\nmeet you!" %name
		end()
	elif number == "3":
		print " %s you're  a Gryffindor! Look - Sir Nicholas de Mimsy-Porpington wants\nto congratulate you!" %name
		end()
	elif number == "4":
		print "Without a doubt, you are a Slytherin! The Bloody Baron is eager to\nmake your acquaintance!" %name
		end()
	elif number == "5":
		print "I cannot decide! You could be sorted into any House. It is now up\nto you to choose." %name
		end()
	else:
...
def mirror_question():
	...
	print "Do you see yourself knowledgable above all?" 
	...
	if "galleons" in desire: 
		...
		print "I promise I won't tell anyone."
		dumbledore_question()
	elif "knowlegable" in desire:
		print "Thank you for trusting me with your deepest desire."
		print "I promise I won't tell anyone."
		pet_question()
	elif "family" in position:
		print "Thank you for trusting me with your deepest desire."
		print "I promise I won't tell anyone."
		person_question()
	else: 
